...
public class VinskaApplication {
    ...
    public CommandLineRunner vinyls(VinylRepository vrepository, GenreRepository grepository, UserRepository userRepository){
        return (args) -> {
           ...
           vrepository.save(new Vinyl("Ozzy","Metall","sabbath", 1999, 2, 20, 200, grepository.findByType("Rock").get(0)));
           // vrepository.save(new Vinyl("Pekka Streng","Kesa","Love", 1995, 2, 20, 100, grepository.findByType("Pop").get(0)));
